...
export default async function HomePage() {
  ...
  const jsonLD = {
    ...
    name: 'Maître Laura Baron - Avocat Dommage Corporel Bayonne',
    description: 'Avocat en dommage corporel et indemnisation des victimes à Bayonne - Pays Basque',
      ...
      <section className="section-padding bg-beige">
        <div className="container-custom no-overflow">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
            ...
            <a
              href="https://chatgpt.com/g/g-68d0726fd7a88191a27ca8d7e440be3d-soutien-aux-victimes-d-accident-me-laura-baron"
              target="_blank"
              rel="noopener noreferrer"
